...
SECRET_KEY = 'django-insecure-q#kub5nui7k4ok%7th6-bxe4$$h&bjmo#m!$3a98srponl3do0'
...
INSTALLED_APPS = [
    ...
    'App_Sumsub.apps.AppSumsubConfig',
]
...
#     raise ValueError("SUMSUB_SECRET_KEY is missing")